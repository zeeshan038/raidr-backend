...
/**
 * @Description Redeem a coupon code when the user visits the outlet
 * @Route POST /api/merchant/ads/redeem-coupon
 * @Access Private
 */
export const redeemCoupon = async (req, res) => {
    ...
    try {
        ...
        // Mark as redeemed
        const updatedCode = await prisma.merchantAdCode.update({
            where: { id: adCode.id },
            data: { 
                isRedeemed: true,
                redeemedAt: new Date()
